...
def load_config(env: dict[str, str] | None = None) -> Config:
    ...
    return Config(
        ...
        source_channel_ids=_int_list(env["SOURCE_CHANNEL_IDS"], "SOURCE_CHANNEL_IDS"),
        report_channel_id=_int(env["REPORT_CHANNEL_ID"].strip(), "REPORT_CHANNEL_ID", 1),
        ...
        analysis_days=_int(env.get("ANALYSIS_DAYS", "7").strip() or "7", "ANALYSIS_DAYS", 1),
        retention_days=_int(env.get("RETENTION_DAYS", "30").strip() or "30", "RETENTION_DAYS", 1),
